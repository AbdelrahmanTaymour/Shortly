...
namespace Shortly.Core.Email.Contracts;
...
public interface IEmailProvider
{
    ...
    /// <returns>
    /// An <see cref="Result"/> indicating success or failure of the operation.
    /// </returns>
    /// <remarks>
    ...
    /// <returns>
    /// A list of <see cref="Result"/> objects, one for each email attempted.
    /// </returns>
    /// <remarks>
    ...
    /// </remarks>
    Task<List<Result>> SendBulkAsync(List<EmailRequest> requests);
}