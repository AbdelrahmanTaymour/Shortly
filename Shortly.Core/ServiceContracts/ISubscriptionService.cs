...
public interface ISubscriptionService
{
    ...
    Task<bool> UpgradeSubscriptionAsync(Guid userId, enSubscriptionPlan plan, CancellationToken cancellationToken = default);
    Task<bool> DowngradeSubscriptionAsync(Guid userId, enSubscriptionPlan plan, CancellationToken cancellationToken = default);
