...
namespace Shortly.Infrastructure.Migrations
{
    ...
    [Migration("20250810073834_Change the ipAddress column's name")]
    partial class ChangetheipAddresscolumnsname
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shortly.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = (byte)4,
                            DefaultPermissions = 9663676415L,
