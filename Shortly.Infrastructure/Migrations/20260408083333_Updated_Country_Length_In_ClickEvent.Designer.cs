...
namespace Shortly.Infrastructure.Migrations
{
    ...
    [Migration("20260408083333_Updated_Country_Length_In_ClickEvent")]
    partial class Updated_Country_Length_In_ClickEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shortly.Domain.Entities.ClickEvent", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ShortUrlId", "ClickedAt"), new[] { "Country", "City", "DeviceType", "Browser", "OperatingSystem", "TrafficSource", "ReferrerDomain", "IpAddress", "SessionId", "UtmSource", "UtmCampaign" });
