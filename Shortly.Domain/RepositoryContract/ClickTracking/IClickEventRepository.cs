...
namespace Shortly.Domain.RepositoryContract.ClickTracking;
...
public interface IClickEventRepository
{
    ...
    /// <summary>
    /// Gets the timestamp of the first click for a specific shortened URL.
    /// </summary>
    /// <param name="shortUrlId">The identifier of the shortened URL</param>
    /// <param name="cancellationToken">Token to monitor for cancellation requests during the async operation</param>
    /// <returns>The timestamp of the first click, or null if no clicks exist</returns>
    /// <exception cref="DatabaseException">Thrown when the database operation fails</exception>
    Task<DateTime?> GetFirstClickAsync(long shortUrlId, CancellationToken cancellationToken = default);


    /// <summary>
    /// Gets the timestamp of the last click for a specific shortened URL.
    /// </summary>
    /// <param name="shortUrlId">The identifier of the shortened URL</param>
    /// <param name="cancellationToken">Token to monitor for cancellation requests during the async operation</param>
    /// <returns>The timestamp of the last click, or null if no clicks exist</returns>
    /// <exception cref="DatabaseException">Thrown when the database operation fails</exception>
    Task<DateTime?> GetLastClickAsync(long shortUrlId, CancellationToken cancellationToken = default);
